  ...
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
      <span className="relative inline-block">
        <span className="absolute -inset-2 bg-gradient-to-r from-[#ffffff] to-[#e5e7eb] blur-2xl opacity-20"></span>
      ...
      <span className="relative inline-block mt-2">
        <span className="absolute -inset-2 bg-gradient-to-r from-[#ffffff] to-[#e5e7eb] blur-2xl opacity-20"></span>
        <span className="relative bg-gradient-to-r from-[#ffffff] to-[#e5e7eb] bg-clip-text text-transparent">
          Engineer
        </span>
      </span>
    </h1>
...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0A0A0A] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] pt-16" id="Home">
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="h-8 flex items-center" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <span className="w-[3px] h-6 bg-gradient-to-t from-[#ffffff] to-[#e5e7eb] ml-1 animate-blink"></span>
                  </div>
