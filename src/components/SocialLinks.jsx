...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "@__cxs_______",
    icon: Instagram,
    url: "https://www.instagram.com/__cxs_______",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@__cxs_______",
    icon: TikTokIcon,
    url: "https://www.tiktok.com/@__cxs_______",
    color: "black",
...
const SocialLinks = () => {
  ...
  const tiktok = otherLinks[2];
  const TikTokIconComponent = tiktok.icon;
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        ...
        data-aos="fade-down"
      >
        <span className="inline-block w-8 h-1 bg-[#ffffff] rounded-full"></span>
        Connect With Me
      </h3>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[otherLinks[0], otherLinks[1]].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
